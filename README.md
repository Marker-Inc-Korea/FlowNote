...
- FastAPI 인증, 승인 단말, 문서, FieldComment, 첨부, 태그, 접근 로그, 작업순서, 채널/인수인계, 보고서, AI 검색 근거 후보 API
- Android 현장 단말 최소 앱: 승인 단말 로그인, 공개 문서 조회, FieldComment, 사진 첨부, 신호등식 기록, 알림/인수인계 조회와 확인, SQLite outbox 재전송

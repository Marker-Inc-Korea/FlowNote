...
아래 항목은 향후 연구를 위한 데이터·승인·안전장치 기반이며, 실제 AI 사용자 기능의 구현 완료 목록이 아니다.
...
실제 외부 AI provider를 사용하는 사용자 검색·요약 화면은 구현 완료 또는 현재 운영 범위가 아니다. 외부 호출 경계는 기본 비활성 상태다.
...
| AI 후보·ground-truth·안전장치 | 후속 연구·시험 기반, 완료 기능 판정 제외 |

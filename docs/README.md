...
Client App
  ...
  -> WebView Bridge: 로컬 제어와 파일 감시

Deployment
  -> MySQL metadata DB
  -> Customer data sovereignty
  -> Customer/site independent instance
...
- [0006. WebView 중심 클라이언트와 네이티브 브릿지](./decisions/0006-webview-client-and-native-bridge.md)
- [0007. 웹 스택, MySQL, 고객 데이터 주권 기반 배포](./decisions/0007-web-stack-mysql-dedicated-deployment.md)
- [0008. 회원 인증과 클라이언트 단계 보안 정책](./decisions/0008-auth-viewer-timeout-download-policy.md)
- [0009. Web 우선 구현 단계](./decisions/0009-web-first-implementation-order.md)

...
이 문서는 2026-07-20 현재 코드 기준이다. 구현되지 않은 기능은 “현재 제외 범위”, “후속 계층 착수 기준”, “후속 MVP 후보”에만 둔다.
...
- 고객·현장·선택적 라인·DB fingerprint scope별 ground-truth 첫 승인과 서로 다른 사용자의 2차 승인, 고정 원천 snapshot/provenance, 실제 현장/스모크 준비도 분리, 외부 호출 없는 회귀 평가 API와 48건 비민감 스모크 검증 도구

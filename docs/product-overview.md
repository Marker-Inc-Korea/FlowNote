...
현재 구현 설명은 2026-08-04 코드 기준이며 장기 제품 방향이나 아직 구현하지 않은 기능은 배포 방향·제외 범위에서 명시적으로 구분한다.
...
- 문서 권위 변경, FieldComment 검토, 보고서 상태 전이와 작업순서 변경의 공통 mutation receipt·감사 event envelope 및 WPF 통합 변경 이력 화면

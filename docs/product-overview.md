...
현재 구현 설명은 2026-07-15 코드 기준이며, 장기 제품 방향이나 아직 구현하지 않은 기능은 배포 방향·제외 범위에서 명시적으로 구분한다.

...
- Windows/Android 공통 업무 채널 알림과 Android 현장 단말 제품 방향 문서화

## 다음 우선순위

1. 공통 채널 알림과 인수인계 서버 모델/API 상세화
2. Windows 채널 수신함, 채널 관리, 인수인계 확인 현황 화면 설계
3. Android 현장 단말의 기능 범위와 기술 스택 결정
4. 현장별 MSI 설치 검증, 코드 서명, self-contained 패키징 조건 정리

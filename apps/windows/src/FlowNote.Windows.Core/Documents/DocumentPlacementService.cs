...
public sealed class DocumentPlacementService(FolderService folders)
{
        ...
        DateTime createdAt)
    {
        ...
        var targetFolder = ResolveTargetFolder(selectedFolder, createdAt);
        return new DocumentRegistrationPlan(targetFolder, title);
    }

    private DocumentFolder ResolveTargetFolder(DocumentFolder selectedFolder, DateTime createdAt)
    {

...
`src/FlowNote.Windows.Core/Auth/`, `Documents/`, `FieldNotes/`, `Folders/`, `Notifications/`, `ServerApi/`, `Sync/`에는 로그인, 문서 등록, 현장 코멘트 원천 이력, 폴더 관리, 알림함, 서버 문서/FieldNote API 클라이언트, 로컬 서버 동기화 큐 서비스가 있다.
